...
const ClientModel = {
  findAll({ search, status, page = 1, limit = 20, sort, order } = {}) {
    ...
    const sortCols = { name: 'name', company: 'company', email: 'email', phone: 'phone', city: 'city', status: 'status', created_at: 'created_at' };
